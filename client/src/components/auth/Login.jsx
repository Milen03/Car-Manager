...
export default function Login() {
    ...
    return (
        <div className="relative min-h-screen bg-gradient-to-br from-gray-950 via-black to-gray-950 text-gray-100 flex flex-col items-center justify-center px-4 overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="relative w-full max-w-sm space-y-4 bg-gray-900/60 backdrop-blur border border-gray-800 rounded-2xl p-8 shadow-lg shadow-black/40">
